# Match3_sim — AI-Native 三消遊戲開發 Pipeline (Demo 系統)

> 為 Google Cloud Day demo 準備的全套示範。三大模組(生成 / 模擬 / 自動測試)串成 AI-Native 遊戲開發 Pipeline。
>
> 註:本文件描述的是 demo 遊戲系統。除另有說明外,以下路徑皆以 **repo 根目錄** 為基準。
...
- **Web Export**:見 [`README_DEMO.md`](README_DEMO.md)
